...
* link:NOTICE_AstraCloudControl_21.12.pdf["Aviso para Astra Control Center"^]
* link:NOTICE_AstraDataStore_Preview_21.12.pdf["Aviso para prévia do Astra Data Store"]
