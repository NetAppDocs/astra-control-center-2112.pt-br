...
summary: Saiba como implantar o MySQL a partir do gráfico Bitnami Helm. Depois de implantar o MySQL no cluster Kubernetes, você pode gerenciar a aplicação com o Astra Control. 
---
