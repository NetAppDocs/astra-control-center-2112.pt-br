...
. Selecione *Remover*.
+
image:screenshot-remove-credentials.gif["Uma captura de tela da guia credenciais na página conta, onde você pode selecionar a coluna de estado e selecionar a ação Remover."]
